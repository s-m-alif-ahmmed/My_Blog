        ...
        <div class="container-fluid text-center text-md-start mt-3">
            <div class="row mt-3">
                <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                    <h6 class="fw-bold text-white fs-4 mb-4">
                ...
                <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                    <h6 class="fw-bold fs-5 text-white mb-4">
                        Categories
                    </h6>
                        <hr>
                        <p>
                            <a href="#" class="text-decoration-none text-primary">Coding Blog</a>
                        </p>
                        <p>
                            <a href="#" class="text-decoration-none text-primary">Celebrity Blog</a>
                        </p>
                        <p>
                            <a href="#" class="text-decoration-none text-primary">Economy Blog</a>
                        </p>
                        <p>
                            <a href="#" class="text-decoration-none text-primary">Tech Blog</a>
                        </p>
                </div>
                <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                    <h6 class="fw-bold fs-5 text-white mb-4">
                    ...
                    <hr>
                        <p>
                            <a href="{{route('about')}}" class="text-decoration-none text-primary">About</a>
                        </p>
                        <p>
                            <a href="{{route('contact')}}" class="text-decoration-none text-primary">Contact</a>
                        </p>
                        ...
                        <p>
                            <a href="" class="text-decoration-none text-primary" onclick="event.preventDefault(); document.getElementById('logoutForm').submit(); ">Logout</a>
                        </p>
